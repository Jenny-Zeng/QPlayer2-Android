...
class CommonPlayerQRCodeWidget: AppCompatImageView, View.OnClickListener, View.OnLongClickListener, View.OnTouchListener,
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        val drawableCompat = ContextCompat.getDrawable(context, R.drawable.ic_scanner)
